{
  wayland.windowManager.hyprland.settings = {
    exec-once = [
      ...
      ''[workspace 1 silent; float; size 620 354; move 10 40] $term --class "fastfetch" --hold uwsm app -- fastfetch --logo $HOME/Pictures/fastfetch_logos/FallenAngel.jpg''
      ...
      "sleep 12; systemctl restart --user cliphist cliphist-images remmina" #These services tried to start to early idk
    ];
  };
}
