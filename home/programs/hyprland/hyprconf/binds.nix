  ...
  wayland.windowManager.hyprland.settings = {
    ...
    bind =
      [
        ...
        ", Print, exec, grimblast --notify edit output || grimblast copy output"
        "$mod, Print, exec, grimblast --notify edit area || grimblast copy area"
        "$mod+Shift, Print, exec, grimblast --notify edit active || grimblast copy active"
        "$mod+Shift+Alt, Print, exec, grimblast --notify edit screen || grimblast copy screen"
        "Alt, P, exec, grimblast --notify edit output || grimblast copy output"
        "Alt+Shift, P, exec, grimblast --notify edit area || grimblast copy area"
        "Alt+Shift+Ctrl, P, exec, grimblast --notify edit active || grimblast copy active"
