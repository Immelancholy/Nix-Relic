  ...
  wayland.windowManager.hyprland.settings = {
    ...
    bind =
      [
        ...
        ", Print, exec, systemctl restart --user waybar"
        "$mod, Print, exec, uwsm-app -- $scr/screenshot.sh sf"
        "$mod, Print, exec, systemctl restart --user waybar"
        "$mod+Shift, Print, exec, uwsm-app -- $scr/screenshot.sh s"
        "$mod+Shift, Print, exec, systemctl restart --user waybar"
        "$mod+Shift+Alt, Print, exec, uwsm-app -- $scr/screenshot.sh p"
        "$mod+Shift+Alt, Print, exec, systemctl restart --user waybar"
        "Alt, P, exec, uwsm-app -- $scr/screenshot.sh m"
        "Alt, P, exec, systemctl restart --user waybar"
        "Alt+Shift, P, exec, uwsm-app -- $scr/screenshot.sh sf"
        "Alt+Shift, P, exec, systemctl restart --user waybar"
        "Alt+Shift+Ctrl, P, exec, uwsm-app -- $scr/screenshot.sh p"
        "Alt+Shift+Ctrl, P, exec, systemctl restart --user waybar"
