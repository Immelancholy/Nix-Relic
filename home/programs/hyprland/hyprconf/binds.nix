  ...
  wayland.windowManager.hyprland.settings = {
    ...
    bind =
      [
        ...
        "$mod, U, exec, [workspace 1 silent; float; size 852 555; move 646 40] $term $scr/rmpc.sh"
        "$mod, U, exec, [workspace 1 silent; float; size 852 465; move 646 605] $term $scr/cava.sh"
