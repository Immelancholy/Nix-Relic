  ...
  wayland.windowManager.hyprland.settings = {
    ...
    bind =
      [
        ...
        "$mod, U, exec, [workspace 1 silent; float; size 852 559; move 646 40] $term $scr/rmpc.sh"
        "$mod, U, exec, [workspace 1 silent; float; size 852 462; move 646 609] $term $scr/cava.sh"
