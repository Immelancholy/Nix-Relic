  ...
  wayland.windowManager.hyprland.settings = {
    ...
    bind =
      [
        ...
        "Ctrl+Shift+Alt, S+Right, movetoworkspace, r+1"
        "Ctrl+Shift+Alt, S+Left, movetoworkspace, r-1"
        "Ctrl+Shift+Alt, S+L, movetoworkspace, r+1"
        "Ctrl+Shift+Alt, S+H, movetoworkspace, r-1"
