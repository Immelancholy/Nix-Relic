  ...
  wayland.windowManager.hyprland.settings = {
    ...
    bind =
      [
        ...
        "$mod, U, exec, [workspace 1 silent; float; size 626 665; move 10 405] $term $scr/btop.sh"
        "$mod, U, exec, [workspace 1 silent; float; size 400 1030; move 1510 40] $term $scr/neo.sh"
        "$mod, U, exec, [workspace 1 silent; float; size 626 355; move 10 40] $term --hold fastfetch"
