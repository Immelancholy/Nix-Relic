  ...
  wayland.windowManager.hyprland.settings = {
    ...
    bind =
      [
        ...
        "$mod+Shift, Print, sleep 1; exec, systemctl restart --user waybar"
        "$mod+Shift+Alt, Print, exec, uwsm-app -- $scr/screenshot.sh p"
        "$mod+Shift+Alt, Print, sleep 1; exec, systemctl restart --user waybar"
        ...
        "Alt+Shift, P, sleep 1; exec, systemctl restart --user waybar"
        "Alt+Shift+Ctrl, P, exec, uwsm-app -- $scr/screenshot.sh p"
        "Alt+Shift+Ctrl, P, sleep 1; exec, systemctl restart --user waybar"
