  ...
  wayland.windowManager.hyprland.settings = {
    ...
    bind =
      [
        ...
        ''$mods, U, exec, [workspace 1 silent; float; size 620 354; move 10 40] $term --class "fastfetch" --hold uwsm app -- fastfetch --logo $HOME/Pictures/fastfetch_logos/FallenAngel.jpg; export class=fastfetch''
