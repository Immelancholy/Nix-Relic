  ...
  wayland.windowManager.hyprland.settings = {
    ...
    bind =
      [
        ...
        "$mod, U, exec, [workspace 1 silent; float; size 852 558; move 646 40] $term $scr/rmpc.sh"
        "$mod, U, exec, [workspace 1 silent; float; size 852 463; move 646 608] $term $scr/cava.sh"
