{
  wayland.windowManager.hyprland.settings = {
    bind = [ 
      ...
      "$mod, I, exec, [workspace 1 silent; float; size 584 557; move 646 38]$term sh $scr/rmpc.sh"
      "$mod, I, exec, [workspace 1 silent; float; size 584 465; move 646 605]$term sh $scr/cava.sh"
