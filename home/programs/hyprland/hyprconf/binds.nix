  ...
  wayland.windowManager.hyprland.settings = {
    ...
    bind =
      [
        ...
        "$mod, Print, exec, sleep 1; systemctl restart --user waybar"
        "$mod+Shift, Print, exec, uwsm-app -- $scr/screenshot.sh s"
        "$mod+Shift, Print, exec, sleep 1;  systemctl restart --user waybar"
        "$mod+Shift+Ctrl, Print, exec, uwsm-app -- $scr/screenshot.sh p"
        # "$mod+Shift+Ctrl, Print, exec, sleep 1; systemctl restart --user waybar"
        "Alt, P, exec, uwsm-app -- $scr/screenshot.sh m"
        "Alt, P, exec, sleep 1; systemctl restart --user waybar"
        "Alt+Shift, P, exec, uwsm-app -- $scr/screenshot.sh sf"
        "Alt+Shift, P, exec, sleep 1; systemctl restart --user waybar"
        "Alt+Shift+Ctrl, P, exec, uwsm-app -- $scr/screenshot.sh p"
        # "Alt+Shift+Ctrl, P, exec, sleep 1; systemctl restart --user waybar"
